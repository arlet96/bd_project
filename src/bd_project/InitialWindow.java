...
public class InitialWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPasswordField1.setText("basico");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Connect con = new Connect("elliptic_curves_prueba");  //cambiar a eliptic curves      
        Consult consult = new Consult(con.GetCon());
        SecondWindow2 sec = new SecondWindow2(consult);
        sec.setVisible(true);
